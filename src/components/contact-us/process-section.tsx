...
const processSteps = [
  { step: "Step 1", title: "Your Enquiry Is Reviewed", items: [
  ...
  { step: "Step 2", title: "Discovery Call – Understanding Your Needs", items: [
  ...
  { step: "Step 3", title: "Proposal Tailored To You", items: [
  ...
  { step: "Step 4", title: "Execution & Guidance", items: [
  ...
  { step: "Step 5", title: "Moving Forward At Your Pace", items: [
