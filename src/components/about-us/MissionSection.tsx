...
export default function MissionSection() {
    return (
        <section className="py-20 ">
            <div className="max-w-7xl mx-auto pl-24 flex flex-col  items-center gap-4">
                    ...
                    <div className="md:w-1/2 space-y-6 text-white">
                        ...
                        <div className="space-y-4  text-gray-300">
                            ...
                            <p>
                                ...
                                expertise, consistent delivery, and clear communication. Our work
                                drives growth, improves efficiency, and keeps clients ahead in an
                        ...
                        <BrilliantButton variant="white" className="mt-6 inline-block bg-white text-black font-medium px-6 py-3 rounded-xl hover:bg-gray-100 transition">
