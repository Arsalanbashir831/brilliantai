				...
				<div
					...
					<div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 p-8 md:p-12">
						...
						<div className="space-y-6 text-gray-300">
							<p>
								We build intelligent, scalable AI systems that transform complex
								ideas into real-world products. From web applications to machine
								learning models and automation, we help entrepreneurs and
								organisations deliver high-impact solutions.
							</p>
							<p>
								Our team accelerates product vision for funded startups and
								integrates AI into key operations for established businesses,
								ensuring speed, reliability, and measurable outcomes.
							</p>
