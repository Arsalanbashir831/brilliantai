  ...
  return (
    <section className="relative w-full flex items-center justify-center overflow-hidden bg-[#011010] px-4 py-24 md:h-[600px] md:py-0">
      ...
      <Image
        ...
        alt="Grid Background"
        fill
        className={`px-1 object-cover md:object-contain pointer-events-none h-[300px] w-[200px]`}
      />

      {/* Content */}
      <div className="relative z-10 text-center md:max-w-[70%] w-auto">
        <h2 className="text-[27px] sm:text-2xl md:text-5xl font-light text-white leading-snug">
          Ready to build what’s next?
          <span className="text-[28px] md:text-5xl">
            <br />
        ...
        <BrilliantButton
          ...
          className="mt-5 px-6 py-3 text-sm md:text-base">
          Get In Touch
        </BrilliantButton>
      </div>
    </section>
