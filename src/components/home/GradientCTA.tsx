...
export default function GradientCTA() {
  ...
  return (
    <section className="max-w-7xl mx-auto w-full flex justify-center px-0 md:px-10 py-24">
      <div
        className="relative w-full mx-auto h-[300px] md:h-[220px] rounded-none md:rounded-xl overflow-hidden flex items-center justify-between px-6 sm:px-10 text-white"
        style={{
