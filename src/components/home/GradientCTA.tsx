...
export default function GradientCTA() {
    return (
        <section className="w-full flex justify-center px-0 md:px-4 py-20">
            <div className="relative w-full max-w-6xl h-[200px] rounded-none md:rounded-xl overflow-hidden flex items-center justify-between px-6 sm:px-10 text-white">
                {/* Background Image */}
                <Image
                    src="/home/grain.svg"
                ...
                <div className="relative z-10 w-full flex flex-col sm:flex-row items-start sm:items-center justify-between">
                    <div className="mb-4 sm:mb-0">
                        <h3 className="text-2xl text-center md:text-left font-semibold mb-1">
                            Want to explore what AI can do for you?
                        </h3>
                        <p className="text-sm text-center md:text-left text-white/80 max-w-md">
