...
export default function Footer() {
  ...
  const description = (
    <p className="text-sm leading-relaxed max-w-xs">
      Brilliant AI is a specialist artificial intelligence engineering company
      focused on designing, building and deploying custom AI systems for
      real-world impact.
    </p>
  );
  ...
  return (
    <footer className=" relative overflow-hidden text-white pb-2 pt-10 md:pt-32 lg:pt-48 bg-[url('/home/Ellipse.png')] bg-repeat bg-center">
          ...
          <div className="hidden lg:grid grid-cols-4 gap-12">
            <div className="space-y-6">
              ...
              <p className="text-sm leading-relaxed">
                Brilliant AI is a specialist artificial intelligence engineering
                company focused on designing, building and deploying custom AI
      ...
      <div className="relative z-10 mt-16 w-full border-t border-gray-700 pt-8 px-6 sm:px-20 lg:px-20 text-center">
        {isMobile && (
          <>
            <div className="flex flex-col items-center mb-6">{socialIcons}</div>
          </>
        )}
        <small className="text-sm text-white lg:w-[60%] mx-auto block">
          Copyright © 2025 Brilliant AI Ltd. All rights reserved. Brilliant AI
          Ltd is a company registered in England and Wales (Company No:
          16134527). Brilliant AI Ltd operates in accordance with applicable UK
