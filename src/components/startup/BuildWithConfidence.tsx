    ...
    <section className="w-full flex justify-center pb-20  sm:px-16 overflow-hidden">
      ...
      <div
        ...
        <p className="mt-3 text-base text-[#E0E0E0] leading-relaxed">
          You have the vision. We have the team, the expertise and the structure
          to deliver it. Let’s create an AI product that is reliable, scalable
        ...
        <div
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-[#E0E0E0] leading-relaxed">
              You have the vision. We have the team, the expertise and the
              structure to deliver it. Let’s create an AI product that is
              reliable, scalable and built to perform.
            </p>
          </div>
