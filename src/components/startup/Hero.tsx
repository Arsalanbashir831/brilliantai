...
export default function Hero() {
  ...
  return (
    <section className="bg-[url('/startup/22.svg')] bg-center bg-cover ">
      ...
      <div className="max-w-7xl mx-auto px-0  md:px-4  sm:px-6 lg:px-5">
        {/* ------------------- HERO TEXT ------------------- */}
        ...
        <div className="py-10 ">
          <div className="flex flex-col md:flex-row justify-center items-center gap-8">
            ...
            <div
              className={`${
                isMobile
                  ? "w-full md:w-1/2 space-y-4 px-3 text-white text-center md:text-left bg-[radial-gradient(circle_300px_at_center,rgba(35,213,213,0.5),transparent)] "
                  : "w-full md:w-1/2 space-y-4 px-3 text-white text-center md:text-left"
              }
    `}>
            ...
            <div className="w-full md:w-1/2 flex justify-center md:justify-end px-0  md:px-3 lg:px-3">
              <div
                className="
                  w-full
                  max-w-[430px]
