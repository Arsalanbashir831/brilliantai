		...
		<div className="px-4 sm:px-6 md:px-40 pb-32">
			...
			<div className="flex flex-col md:flex-row justify-center items-start gap-4 pt-16">
				...
				<div className="flex flex-col items-stretch w-full md:w-80 mt-8">
					{/* Title */}
					<div
						className="flex flex-col justify-center items-center gap-2 w-full h-16 px-8 rounded-tl-lg rounded-tr-lg
            ...
            shadow-[inset_-20px_4px_120px_-80px_rgba(31,187,187,0.14)] backdrop-blur-[15px]">
						<span className="text-white font-medium text-xl leading-6">
							Freelancers
						</span>
					</div>
					{/* Body */}
					<div
						className="flex flex-col items-center gap-10 w-full pt-px pb-12
            ...
            shadow-[inset_-20px_4px_120px_-80px_rgba(31,187,187,0.14)] backdrop-blur-[15px]">
				...
				<div className="flex flex-col items-stretch w-full md:w-96 mt-4 ">
					{/* Title */}
					<div
						className="flex flex-col justify-center items-center gap-[10px] w-full h-16 px-[32px]
            rounded-tl-[16px] rounded-tr-[16px]
            bg-[linear-gradient(111deg,_rgba(77,77,77,0.24)_1.21%,_rgba(151,151,151,0.04)_100%)]
            shadow-[inset_-20px_4px_120px_0px_rgba(31,187,187,0.14)] backdrop-blur-[15px]">
						<span className="text-white font-medium text-[30px] leading-[24px]">
							Brilliant AI
						</span>
					</div>
					{/* Body */}
					<div
						className="flex flex-col items-center  gap-[49px] w-full pb-[60px]
            ...
            shadow-[inset_-20px_4px_120px_0px_rgba(31,187,187,0.14)] backdrop-blur-[15px]">
				...
				<div className="flex flex-col items-stretch w-full md:w-80 mt-8">
					{/* Title */}
					<div
						className="flex flex-col justify-center items-center gap-2 w-full h-16 px-8 
