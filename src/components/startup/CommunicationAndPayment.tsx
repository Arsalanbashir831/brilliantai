...
export default function CommunicationAndPayment() {
  return (
    <section
      className="
        max-w-7xl    /* cap the total width */
        mx-auto             /* center it */
        md:px-0 px-6  /* responsive horizontal padding */
        py-20
      ">
      {/* Row 1 */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center justify-between">
        ...
        <div className="space-y-4">
          ...
          <h3 className="text-2xl md:text-4xl lg:text-4xl font-semibold text-white">
          ...
          <ul className="space-y-4">
            {[
              ...
              <li key={txt} className="flex items-start gap-4">
                <Check className="w-5 h-5 shrink-0 text-[#E0E0E0]" />
